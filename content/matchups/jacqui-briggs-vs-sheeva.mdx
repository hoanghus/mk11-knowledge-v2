---
slug: jacqui-briggs-vs-sheeva
title: "jacqui briggs vs sheeva"
characterA: jacqui-briggs
characterB: sheeva
summary: "Sheeva vs Jacqui Briggs matchup notes với baseline từ dataset thi đấu (sample 3 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# jacqui briggs vs sheeva

## Overview

- Baseline sample: **3** trận ghi nhận.
- Reference winrate snapshot (perspective Sheeva): **67%**.

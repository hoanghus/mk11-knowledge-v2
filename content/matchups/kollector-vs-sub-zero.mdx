---
slug: kollector-vs-sub-zero
title: "kollector vs sub zero"
characterA: kollector
characterB: sub-zero
summary: "Kollector vs Sub-Zero matchup notes với baseline từ dataset thi đấu (sample 10 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# kollector vs sub zero

## Overview

- Baseline sample: **10** trận ghi nhận.
- Reference winrate snapshot (perspective Kollector): **60%**.

---
slug: rain-vs-sub-zero
title: "rain vs sub zero"
characterA: rain
characterB: sub-zero
summary: "Rain vs Sub-Zero matchup notes với baseline từ dataset thi đấu (sample 11 trận)."
tags:
  - matchup
  - neutral
  - punish
...
- Reference winrate snapshot (perspective Rain): **55%**.

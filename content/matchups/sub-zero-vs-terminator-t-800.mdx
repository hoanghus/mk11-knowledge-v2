---
slug: sub-zero-vs-terminator-t-800
title: "sub zero vs terminator t 800"
characterA: sub-zero
characterB: terminator-t-800
summary: "Terminator T-800 vs Sub-Zero matchup notes với baseline từ dataset thi đấu (sample 4 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# sub zero vs terminator t 800

## Overview

- Baseline sample: **4** trận ghi nhận.
- Reference winrate snapshot (perspective Terminator T-800): **25%**.

---
slug: erron-black-vs-frost
title: "erron black vs frost"
characterA: erron-black
characterB: frost
summary: "Frost vs Erron Black matchup notes với baseline từ dataset thi đấu (sample 6 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# erron black vs frost

## Overview

- Baseline sample: **6** trận ghi nhận.
- Reference winrate snapshot (perspective Frost): **17%**.

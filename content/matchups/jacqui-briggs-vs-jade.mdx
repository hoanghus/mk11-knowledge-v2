---
slug: jacqui-briggs-vs-jade
title: "jacqui briggs vs jade"
characterA: jacqui-briggs
characterB: jade
summary: "Jade vs Jacqui Briggs matchup notes với baseline từ dataset thi đấu (sample 18 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# jacqui briggs vs jade

## Overview

- Baseline sample: **18** trận ghi nhận.
- Reference winrate snapshot (perspective Jade): **50%**.

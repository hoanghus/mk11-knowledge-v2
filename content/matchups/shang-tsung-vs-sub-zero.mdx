...
characterB: sub-zero
summary: "Shang Tsung vs Sub-Zero matchup notes với baseline từ dataset thi đấu (sample 39 trận)."
tags:
  - matchup
  - neutral
  - punish
...
- Baseline sample: **39** trận ghi nhận.
- Reference winrate snapshot (perspective Shang Tsung): **69%**.

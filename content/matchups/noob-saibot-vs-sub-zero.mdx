---
slug: noob-saibot-vs-sub-zero
title: "noob saibot vs sub zero"
characterA: noob-saibot
characterB: sub-zero
summary: "Noob Saibot vs Sub-Zero matchup notes với baseline từ dataset thi đấu (sample 11 trận)."
tags:
  - matchup
  - neutral
  - punish
...
- Reference winrate snapshot (perspective Noob Saibot): **18%**.

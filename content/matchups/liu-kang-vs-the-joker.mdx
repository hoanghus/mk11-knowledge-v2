---
slug: liu-kang-vs-the-joker
title: "liu kang vs the joker"
characterA: liu-kang
characterB: the-joker
summary: "Liu Kang vs The Joker matchup notes với baseline từ dataset thi đấu (sample 13 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# liu kang vs the joker

## Overview

- Baseline sample: **13** trận ghi nhận.
- Reference winrate snapshot (perspective Liu Kang): **31%**.

...
characterA: cetrion
characterB: liu-kang
summary: "Cetrion vs Liu Kang matchup notes với baseline từ dataset thi đấu (sample 32 trận)."
tags:
  - matchup
  - neutral
  - punish
...
- Baseline sample: **32** trận ghi nhận.
- Reference winrate snapshot (perspective Cetrion): **63%**.

---
slug: fujin-vs-terminator-t-800
title: "fujin vs terminator t 800"
characterA: fujin
characterB: terminator-t-800
summary: "Terminator T-800 vs Fujin matchup notes với baseline từ dataset thi đấu (sample 4 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# fujin vs terminator t 800

## Overview

- Baseline sample: **4** trận ghi nhận.
- Reference winrate snapshot (perspective Terminator T-800): **50%**.

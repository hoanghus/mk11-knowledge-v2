---
slug: jacqui-briggs-vs-rain
title: "jacqui briggs vs rain"
characterA: jacqui-briggs
characterB: rain
summary: "Rain vs Jacqui Briggs matchup notes với baseline từ dataset thi đấu (sample 21 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# jacqui briggs vs rain

## Overview

- Baseline sample: **21** trận ghi nhận.
- Reference winrate snapshot (perspective Rain): **67%**.

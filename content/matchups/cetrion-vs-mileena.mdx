---
slug: cetrion-vs-mileena
title: "cetrion vs mileena"
characterA: cetrion
characterB: mileena
summary: "Mileena vs Cetrion matchup notes với baseline từ dataset thi đấu (sample 6 trận)."
tags:
  - matchup
  - neutral
  - punish
...
- Reference winrate snapshot (perspective Mileena): **0%**.

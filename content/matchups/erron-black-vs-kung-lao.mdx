---
slug: erron-black-vs-kung-lao
title: "erron black vs kung lao"
characterA: erron-black
characterB: kung-lao
summary: "Erron Black vs Kung Lao matchup notes với baseline từ dataset thi đấu (sample 22 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# erron black vs kung lao

## Overview

- Baseline sample: **22** trận ghi nhận.
- Reference winrate snapshot (perspective Erron Black): **45%**.

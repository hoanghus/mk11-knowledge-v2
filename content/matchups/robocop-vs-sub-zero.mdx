---
slug: robocop-vs-sub-zero
title: "robocop vs sub zero"
characterA: robocop
characterB: sub-zero
summary: "RoboCop vs Sub-Zero matchup notes với baseline từ dataset thi đấu (sample 20 trận)."
tags:
  - matchup
  - neutral
  - punish
...
- Reference winrate snapshot (perspective RoboCop): **45%**.

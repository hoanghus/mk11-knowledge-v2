...
characterB: kabal
summary: "Jacqui Briggs vs Kabal matchup notes với baseline từ dataset thi đấu (sample 30 trận)."
tags:
  - matchup
  - neutral
  - punish
...
- Baseline sample: **30** trận ghi nhận.
- Reference winrate snapshot (perspective Jacqui Briggs): **57%**.

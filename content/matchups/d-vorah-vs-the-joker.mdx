---
slug: d-vorah-vs-the-joker
title: "d vorah vs the joker"
characterA: d-vorah
characterB: the-joker
summary: "D'Vorah vs The Joker matchup notes với baseline từ dataset thi đấu (sample 1 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# d vorah vs the joker

## Overview

- Baseline sample: **1** trận ghi nhận.
- Reference winrate snapshot (perspective D'Vorah): **100%**.

---
slug: jacqui-briggs-vs-scorpion
title: "jacqui briggs vs scorpion"
characterA: jacqui-briggs
characterB: scorpion
summary: "Scorpion vs Jacqui Briggs matchup notes với baseline từ dataset thi đấu (sample 18 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# jacqui briggs vs scorpion

## Overview

- Baseline sample: **18** trận ghi nhận.
- Reference winrate snapshot (perspective Scorpion): **39%**.

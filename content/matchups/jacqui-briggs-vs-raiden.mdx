---
slug: jacqui-briggs-vs-raiden
title: "jacqui briggs vs raiden"
characterA: jacqui-briggs
characterB: raiden
summary: "Raiden vs Jacqui Briggs matchup notes với baseline từ dataset thi đấu (sample 2 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# jacqui briggs vs raiden

## Overview

- Baseline sample: **2** trận ghi nhận.
- Reference winrate snapshot (perspective Raiden): **0%**.

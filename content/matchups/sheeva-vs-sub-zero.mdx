---
slug: sheeva-vs-sub-zero
title: "sheeva vs sub zero"
characterA: sheeva
characterB: sub-zero
summary: "Sheeva vs Sub-Zero matchup notes với baseline từ dataset thi đấu (sample 5 trận)."
tags:
  - matchup
  - neutral
  - punish
...
- Reference winrate snapshot (perspective Sheeva): **60%**.

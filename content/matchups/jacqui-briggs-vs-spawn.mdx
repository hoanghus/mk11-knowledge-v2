---
slug: jacqui-briggs-vs-spawn
title: "jacqui briggs vs spawn"
characterA: jacqui-briggs
characterB: spawn
summary: "Spawn vs Jacqui Briggs matchup notes với baseline từ dataset thi đấu (sample 13 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# jacqui briggs vs spawn

## Overview

- Baseline sample: **13** trận ghi nhận.
- Reference winrate snapshot (perspective Spawn): **38%**.

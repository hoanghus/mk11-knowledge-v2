---
slug: jade-vs-terminator-t-800
title: "jade vs terminator t 800"
characterA: jade
characterB: terminator-t-800
summary: "Terminator T-800 vs Jade matchup notes với baseline từ dataset thi đấu (sample 3 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# jade vs terminator t 800

## Overview

- Baseline sample: **3** trận ghi nhận.
- Reference winrate snapshot (perspective Terminator T-800): **67%**.

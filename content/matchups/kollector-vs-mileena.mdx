---
slug: kollector-vs-mileena
title: "kollector vs mileena"
characterA: kollector
characterB: mileena
summary: "Kollector vs Mileena matchup notes với baseline từ dataset thi đấu (sample 2 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# kollector vs mileena

## Overview

- Baseline sample: **2** trận ghi nhận.
- Reference winrate snapshot (perspective Kollector): **50%**.

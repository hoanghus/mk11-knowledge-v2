---
slug: jade-vs-sindel
title: "jade vs sindel"
characterA: jade
characterB: sindel
summary: "Sindel vs Jade matchup notes với baseline từ dataset thi đấu (sample 7 trận)."
tags:
  - matchup
  - neutral
  - punish
...
- Reference winrate snapshot (perspective Sindel): **86%**.

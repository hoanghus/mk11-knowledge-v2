---
slug: skarlet-vs-the-joker
title: "skarlet vs the joker"
characterA: skarlet
characterB: the-joker
summary: "Skarlet vs The Joker matchup notes với baseline từ dataset thi đấu (sample 14 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# skarlet vs the joker

## Overview

- Baseline sample: **14** trận ghi nhận.
- Reference winrate snapshot (perspective Skarlet): **29%**.

---
slug: erron-black-vs-the-joker
title: "erron black vs the joker"
characterA: erron-black
characterB: the-joker
summary: "Erron Black vs The Joker matchup notes với baseline từ dataset thi đấu (sample 15 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# erron black vs the joker

## Overview

- Baseline sample: **15** trận ghi nhận.
- Reference winrate snapshot (perspective Erron Black): **40%**.

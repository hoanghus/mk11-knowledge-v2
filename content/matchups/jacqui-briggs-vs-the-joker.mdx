---
slug: jacqui-briggs-vs-the-joker
title: "jacqui briggs vs the joker"
characterA: jacqui-briggs
characterB: the-joker
summary: "The Joker vs Jacqui Briggs matchup notes với baseline từ dataset thi đấu (sample 11 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# jacqui briggs vs the joker

## Overview

- Baseline sample: **11** trận ghi nhận.
- Reference winrate snapshot (perspective The Joker): **45%**.

---
slug: erron-black-vs-raiden
title: "erron black vs raiden"
characterA: erron-black
characterB: raiden
summary: "Raiden vs Erron Black matchup notes với baseline từ dataset thi đấu (sample 3 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# erron black vs raiden

## Overview

- Baseline sample: **3** trận ghi nhận.
- Reference winrate snapshot (perspective Raiden): **67%**.

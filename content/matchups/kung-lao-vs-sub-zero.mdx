---
slug: kung-lao-vs-sub-zero
title: "kung lao vs sub zero"
characterA: kung-lao
characterB: sub-zero
summary: "Kung Lao vs Sub-Zero matchup notes với baseline từ dataset thi đấu (sample 16 trận)."
tags:
  - matchup
  - neutral
  - punish
...
- Reference winrate snapshot (perspective Kung Lao): **38%**.

---
slug: kotal-kahn-vs-sub-zero
title: "kotal kahn vs sub zero"
characterA: kotal-kahn
characterB: sub-zero
summary: "Kotal Kahn vs Sub-Zero matchup notes với baseline từ dataset thi đấu (sample 20 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# kotal kahn vs sub zero

## Overview

- Baseline sample: **20** trận ghi nhận.
- Reference winrate snapshot (perspective Kotal Kahn): **65%**.

...
characterA: cetrion
characterB: sub-zero
summary: "Cetrion vs Sub-Zero matchup notes với baseline từ dataset thi đấu (sample 74 trận)."
tags:
  - matchup
  - neutral
  - punish
...
- Baseline sample: **74** trận ghi nhận.
- Reference winrate snapshot (perspective Cetrion): **47%**.

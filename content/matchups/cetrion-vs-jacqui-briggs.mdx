...
summary: "Cetrion vs Jacqui Briggs matchup notes với baseline từ dataset thi đấu (sample 98 trận)."
tags:
  - matchup
  - neutral
  - punish
...
- Baseline sample: **98** trận ghi nhận.
- Reference winrate snapshot (perspective Cetrion): **52%**.

...
summary: "Cetrion vs The Joker matchup notes với baseline từ dataset thi đấu (sample 36 trận)."
tags:
  - matchup
  - neutral
  - punish
...
- Baseline sample: **36** trận ghi nhận.
- Reference winrate snapshot (perspective Cetrion): **44%**.

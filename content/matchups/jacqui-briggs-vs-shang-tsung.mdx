...
summary: "Jacqui Briggs vs Shang Tsung matchup notes với baseline từ dataset thi đấu (sample 26 trận)."
tags:
  - matchup
  - neutral
  - punish
...
- Baseline sample: **26** trận ghi nhận.
- Reference winrate snapshot (perspective Jacqui Briggs): **62%**.

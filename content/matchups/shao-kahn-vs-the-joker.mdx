---
slug: shao-kahn-vs-the-joker
title: "shao kahn vs the joker"
characterA: shao-kahn
characterB: the-joker
summary: "Shao Kahn vs The Joker matchup notes với baseline từ dataset thi đấu (sample 6 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# shao kahn vs the joker

## Overview

- Baseline sample: **6** trận ghi nhận.
- Reference winrate snapshot (perspective Shao Kahn): **83%**.

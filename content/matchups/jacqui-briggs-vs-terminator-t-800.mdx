---
slug: jacqui-briggs-vs-terminator-t-800
title: "jacqui briggs vs terminator t 800"
characterA: jacqui-briggs
characterB: terminator-t-800
summary: "Terminator T-800 vs Jacqui Briggs matchup notes với baseline từ dataset thi đấu (sample 10 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# jacqui briggs vs terminator t 800

## Overview

- Baseline sample: **10** trận ghi nhận.
- Reference winrate snapshot (perspective Terminator T-800): **80%**.

---
slug: jacqui-briggs-vs-robocop
title: "jacqui briggs vs robocop"
characterA: jacqui-briggs
characterB: robocop
summary: "RoboCop vs Jacqui Briggs matchup notes với baseline từ dataset thi đấu (sample 8 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# jacqui briggs vs robocop

## Overview

- Baseline sample: **8** trận ghi nhận.
- Reference winrate snapshot (perspective RoboCop): **25%**.

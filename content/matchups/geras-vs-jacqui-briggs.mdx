...
summary: "Geras vs Jacqui Briggs matchup notes với baseline từ dataset thi đấu (sample 44 trận)."
tags:
  - matchup
  - neutral
  - punish
...
- Baseline sample: **44** trận ghi nhận.
- Reference winrate snapshot (perspective Geras): **41%**.

---
slug: cassie-cage-vs-the-joker
title: "cassie cage vs the joker"
characterA: cassie-cage
characterB: the-joker
summary: "Cassie Cage vs The Joker matchup notes với baseline từ dataset thi đấu (sample 7 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# cassie cage vs the joker

## Overview

- Baseline sample: **7** trận ghi nhận.
- Reference winrate snapshot (perspective Cassie Cage): **57%**.

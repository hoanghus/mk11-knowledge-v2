---
slug: johnny-cage-vs-terminator-t-800
title: "johnny cage vs terminator t 800"
characterA: johnny-cage
characterB: terminator-t-800
summary: "Terminator T-800 vs Johnny Cage matchup notes với baseline từ dataset thi đấu (sample 4 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# johnny cage vs terminator t 800

## Overview

- Baseline sample: **4** trận ghi nhận.
- Reference winrate snapshot (perspective Terminator T-800): **75%**.

---
slug: frost-vs-terminator-t-800
title: "frost vs terminator t 800"
characterA: frost
characterB: terminator-t-800
summary: "Frost vs Terminator T-800 matchup notes với baseline từ dataset thi đấu (sample 4 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# frost vs terminator t 800

## Overview

- Baseline sample: **4** trận ghi nhận.
- Reference winrate snapshot (perspective Frost): **100%**.

---
slug: kotal-kahn-vs-skarlet
title: "kotal kahn vs skarlet"
characterA: kotal-kahn
characterB: skarlet
summary: "Skarlet vs Kotal Kahn matchup notes với baseline từ dataset thi đấu (sample 9 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# kotal kahn vs skarlet

## Overview

- Baseline sample: **9** trận ghi nhận.
- Reference winrate snapshot (perspective Skarlet): **67%**.

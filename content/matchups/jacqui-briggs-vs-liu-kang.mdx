---
slug: jacqui-briggs-vs-liu-kang
title: "jacqui briggs vs liu kang"
characterA: jacqui-briggs
characterB: liu-kang
summary: "Liu Kang vs Jacqui Briggs matchup notes với baseline từ dataset thi đấu (sample 12 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# jacqui briggs vs liu kang

## Overview

- Baseline sample: **12** trận ghi nhận.
- Reference winrate snapshot (perspective Liu Kang): **75%**.

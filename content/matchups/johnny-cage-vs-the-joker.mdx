...
summary: "Johnny Cage vs The Joker matchup notes với baseline từ dataset thi đấu (sample 24 trận)."
tags:
  - matchup
  - neutral
  - punish
...
- Baseline sample: **24** trận ghi nhận.
- Reference winrate snapshot (perspective Johnny Cage): **29%**.

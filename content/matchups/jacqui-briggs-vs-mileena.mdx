---
slug: jacqui-briggs-vs-mileena
title: "jacqui briggs vs mileena"
characterA: jacqui-briggs
characterB: mileena
summary: "Mileena vs Jacqui Briggs matchup notes với baseline từ dataset thi đấu (sample 3 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# jacqui briggs vs mileena

## Overview

- Baseline sample: **3** trận ghi nhận.
- Reference winrate snapshot (perspective Mileena): **100%**.

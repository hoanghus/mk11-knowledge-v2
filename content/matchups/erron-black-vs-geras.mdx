---
slug: erron-black-vs-geras
title: "erron black vs geras"
characterA: erron-black
characterB: geras
summary: "Erron Black vs Geras matchup notes với baseline từ dataset thi đấu (sample 15 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# erron black vs geras

## Overview

- Baseline sample: **15** trận ghi nhận.
- Reference winrate snapshot (perspective Erron Black): **13%**.

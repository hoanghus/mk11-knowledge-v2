---
slug: jax-vs-terminator-t-800
title: "jax vs terminator t 800"
characterA: jax
characterB: terminator-t-800
summary: "Jax vs Terminator T-800 matchup notes với baseline từ dataset thi đấu (sample 3 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# jax vs terminator t 800

## Overview

- Baseline sample: **3** trận ghi nhận.
- Reference winrate snapshot (perspective Jax): **0%**.

...
characterB: sindel
summary: "Jacqui Briggs vs Sindel matchup notes với baseline từ dataset thi đấu (sample 61 trận)."
tags:
  - matchup
  - neutral
  - punish
...
- Baseline sample: **61** trận ghi nhận.
- Reference winrate snapshot (perspective Jacqui Briggs): **46%**.

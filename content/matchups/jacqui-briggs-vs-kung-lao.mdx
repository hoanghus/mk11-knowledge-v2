...
characterB: kung-lao
summary: "Jacqui Briggs vs Kung Lao matchup notes với baseline từ dataset thi đấu (sample 45 trận)."
tags:
  - matchup
  - neutral
  - punish
...
- Baseline sample: **45** trận ghi nhận.
- Reference winrate snapshot (perspective Jacqui Briggs): **44%**.

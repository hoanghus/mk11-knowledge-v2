---
slug: d-vorah-vs-sub-zero
title: "d vorah vs sub zero"
characterA: d-vorah
characterB: sub-zero
summary: "D'Vorah vs Sub-Zero matchup notes với baseline từ dataset thi đấu (sample 5 trận)."
tags:
  - matchup
  - neutral
  - punish
...
- Reference winrate snapshot (perspective D'Vorah): **60%**.

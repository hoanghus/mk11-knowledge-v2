...
summary: "Johnny Cage vs Jacqui Briggs matchup notes với baseline từ dataset thi đấu (sample 26 trận)."
tags:
  - matchup
  - neutral
  - punish
...
- Reference winrate snapshot (perspective Johnny Cage): **62%**.

---
slug: sindel-vs-terminator-t-800
title: "sindel vs terminator t 800"
characterA: sindel
characterB: terminator-t-800
summary: "Terminator T-800 vs Sindel matchup notes với baseline từ dataset thi đấu (sample 5 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# sindel vs terminator t 800

## Overview

- Baseline sample: **5** trận ghi nhận.
- Reference winrate snapshot (perspective Terminator T-800): **0%**.

...
characterA: geras
characterB: sub-zero
summary: "Geras vs Sub-Zero matchup notes với baseline từ dataset thi đấu (sample 37 trận)."
tags:
  - matchup
  - neutral
  - punish
...
- Baseline sample: **37** trận ghi nhận.
- Reference winrate snapshot (perspective Geras): **54%**.

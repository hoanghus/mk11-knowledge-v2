---
slug: frost-vs-sub-zero
title: "frost vs sub zero"
characterA: frost
characterB: sub-zero
summary: "Frost vs Sub-Zero matchup notes với baseline từ dataset thi đấu (sample 6 trận)."
tags:
  - matchup
  - neutral
  - punish
...
- Reference winrate snapshot (perspective Frost): **83%**.

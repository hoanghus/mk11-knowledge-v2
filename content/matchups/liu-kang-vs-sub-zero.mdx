---
slug: liu-kang-vs-sub-zero
title: "liu kang vs sub zero"
characterA: liu-kang
characterB: sub-zero
summary: "Liu Kang vs Sub-Zero matchup notes với baseline từ dataset thi đấu (sample 13 trận)."
tags:
  - matchup
  - neutral
  - punish
...
- Reference winrate snapshot (perspective Liu Kang): **46%**.

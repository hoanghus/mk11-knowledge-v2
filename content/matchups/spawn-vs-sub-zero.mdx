---
slug: spawn-vs-sub-zero
title: "spawn vs sub zero"
characterA: spawn
characterB: sub-zero
summary: "Spawn vs Sub-Zero matchup notes với baseline từ dataset thi đấu (sample 9 trận)."
tags:
  - matchup
  - neutral
  - punish
...
- Reference winrate snapshot (perspective Spawn): **33%**.

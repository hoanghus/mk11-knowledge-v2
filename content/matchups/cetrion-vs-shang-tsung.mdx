---
slug: cetrion-vs-shang-tsung
title: "cetrion vs shang tsung"
characterA: cetrion
characterB: shang-tsung
summary: "Shang Tsung vs Cetrion matchup notes với baseline từ dataset thi đấu (sample 11 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# cetrion vs shang tsung

## Overview

- Baseline sample: **11** trận ghi nhận.
- Reference winrate snapshot (perspective Shang Tsung): **45%**.

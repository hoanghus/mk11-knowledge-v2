---
slug: kollector-vs-kotal-kahn
title: "kollector vs kotal kahn"
characterA: kollector
characterB: kotal-kahn
summary: "Kollector vs Kotal Kahn matchup notes với baseline từ dataset thi đấu (sample 5 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# kollector vs kotal kahn

## Overview

- Baseline sample: **5** trận ghi nhận.
- Reference winrate snapshot (perspective Kollector): **40%**.

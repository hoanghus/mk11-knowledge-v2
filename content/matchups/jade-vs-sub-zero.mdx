---
slug: jade-vs-sub-zero
title: "jade vs sub zero"
characterA: jade
characterB: sub-zero
summary: "Jade vs Sub-Zero matchup notes với baseline từ dataset thi đấu (sample 18 trận)."
tags:
  - matchup
  - neutral
  - punish
...
- Reference winrate snapshot (perspective Jade): **61%**.

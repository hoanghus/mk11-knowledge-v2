---
slug: jacqui-briggs-vs-jax
title: "jacqui briggs vs jax"
characterA: jacqui-briggs
characterB: jax
summary: "Jax vs Jacqui Briggs matchup notes với baseline từ dataset thi đấu (sample 5 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# jacqui briggs vs jax

## Overview

- Baseline sample: **5** trận ghi nhận.
- Reference winrate snapshot (perspective Jax): **100%**.

---
slug: cetrion-vs-spawn
title: "cetrion vs spawn"
characterA: cetrion
characterB: spawn
summary: "Spawn vs Cetrion matchup notes với baseline từ dataset thi đấu (sample 9 trận)."
tags:
  - matchup
  - neutral
  - punish
...
- Reference winrate snapshot (perspective Spawn): **11%**.

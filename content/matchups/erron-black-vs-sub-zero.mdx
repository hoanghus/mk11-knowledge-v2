...
characterB: sub-zero
summary: "Erron Black vs Sub-Zero matchup notes với baseline từ dataset thi đấu (sample 25 trận)."
tags:
  - matchup
  - neutral
  - punish
...
- Baseline sample: **25** trận ghi nhận.
- Reference winrate snapshot (perspective Erron Black): **36%**.

---
slug: fujin-vs-jacqui-briggs
title: "fujin vs jacqui briggs"
characterA: fujin
characterB: jacqui-briggs
summary: "Fujin vs Jacqui Briggs matchup notes với baseline từ dataset thi đấu (sample 17 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# fujin vs jacqui briggs

## Overview

- Baseline sample: **17** trận ghi nhận.
- Reference winrate snapshot (perspective Fujin): **35%**.

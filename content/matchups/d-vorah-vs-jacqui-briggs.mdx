---
slug: d-vorah-vs-jacqui-briggs
title: "d vorah vs jacqui briggs"
characterA: d-vorah
characterB: jacqui-briggs
summary: "D'Vorah vs Jacqui Briggs matchup notes với baseline từ dataset thi đấu (sample 2 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# d vorah vs jacqui briggs

## Overview

- Baseline sample: **2** trận ghi nhận.
- Reference winrate snapshot (perspective D'Vorah): **0%**.

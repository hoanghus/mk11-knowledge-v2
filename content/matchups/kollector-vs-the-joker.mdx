---
slug: kollector-vs-the-joker
title: "kollector vs the joker"
characterA: kollector
characterB: the-joker
summary: "Kollector vs The Joker matchup notes với baseline từ dataset thi đấu (sample 6 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# kollector vs the joker

## Overview

- Baseline sample: **6** trận ghi nhận.
- Reference winrate snapshot (perspective Kollector): **17%**.

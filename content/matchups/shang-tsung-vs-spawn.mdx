---
slug: shang-tsung-vs-spawn
title: "shang tsung vs spawn"
characterA: shang-tsung
characterB: spawn
summary: "Spawn vs Shang Tsung matchup notes với baseline từ dataset thi đấu (sample 5 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# shang tsung vs spawn

## Overview

- Baseline sample: **5** trận ghi nhận.
- Reference winrate snapshot (perspective Spawn): **60%**.

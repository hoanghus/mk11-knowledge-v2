---
slug: sindel-vs-sub-zero
title: "sindel vs sub zero"
characterA: sindel
characterB: sub-zero
summary: "Sindel vs Sub-Zero matchup notes với baseline từ dataset thi đấu (sample 15 trận)."
tags:
  - matchup
  - neutral
  - punish
...
- Reference winrate snapshot (perspective Sindel): **27%**.

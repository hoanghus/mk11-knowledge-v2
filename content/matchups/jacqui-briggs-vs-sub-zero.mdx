...
characterB: sub-zero
summary: "Jacqui Briggs vs Sub-Zero matchup notes với baseline từ dataset thi đấu (sample 31 trận)."
tags:
  - matchup
  - neutral
  - punish
...
- Baseline sample: **31** trận ghi nhận.
- Reference winrate snapshot (perspective Jacqui Briggs): **61%**.

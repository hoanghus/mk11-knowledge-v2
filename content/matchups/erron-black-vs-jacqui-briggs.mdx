---
slug: erron-black-vs-jacqui-briggs
title: "erron black vs jacqui briggs"
characterA: erron-black
characterB: jacqui-briggs
summary: "Erron Black vs Jacqui Briggs matchup notes với baseline từ dataset thi đấu (sample 17 trận)."
tags:
  - matchup
  - neutral
  - punish
...
# erron black vs jacqui briggs

## Overview

- Baseline sample: **17** trận ghi nhận.
- Reference winrate snapshot (perspective Erron Black): **47%**.
